        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                ...
                <p>Old Bus Stand, Shahid Chowk,<br />Garoth, Distt-Mandsaur,<br />Madhya Pradesh - 458880</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="hover:text-primary-200">About Us</a></li>
              <li><a href="/products" className="hover:text-primary-200">Products</a></li>
              <li><a href="/contact" className="hover:text-primary-200">Contact</a></li>
              <li><a href="/privacy-policy" className="hover:text-primary-200">Privacy Policy</a></li>
            </ul>
          </div>
